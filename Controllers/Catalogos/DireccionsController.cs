...
namespace Proyecto.Controllers.Catalogos
{
    public class DireccionsController : Controller
    {
        ...
        public DireccionsController(PruebaProyecto1Context context)
        {
            _context = context;
        }
        ...
        {
              return View(await _context.Direccions.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Provincia,Canton,Distrito,Sennas")] Direccion direccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Provincia,Canton,Distrito,Sennas")] Direccion direccion)
        {
            if (id != direccion.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PruebaProyecto1Context.Direccions'  is null.");
            }
            var direccion = await _context.Direccions.FindAsync(id);
            if (direccion != null)
            {
