...
namespace Proyecto.Controllers.Catalogos
{
    public class PrioridadsController : Controller
    {
        ...
        public PrioridadsController(PruebaProyecto1Context context)
        {
            _context = context;
        }
        ...
        {
              return View(await _context.Prioridads.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PruebaProyecto1Context.Prioridads'  is null.");
            }
            var prioridad = await _context.Prioridads.FindAsync(id);
            if (prioridad != null)
            {
        ...
        {
          return _context.Prioridads.Any(e => e.Id == id);
        }
    }
}
